<section class="carpools">
    ...
    <?php if (empty($departureCity) || empty($arrivalCity) || empty($requestedDate)): ?>
        ...
        <p>
            Aucun covoiturage n’est affiché par défaut. Veuillez utiliser le formulaire de recherche sur
            la page d’accueil pour choisir une ville de départ, une ville d’arrivée et une date.
        </p>
    ...
    <?php else: ?>
        ...
        <p>
            ...
            le
            <strong><?= htmlspecialchars(date('d/m/Y', strtotime($requestedDate))) ?></strong>.
        </p>
                    ...
                    <article class="carpool-card">
                        <div class="carpool-header">
                            <div class="driver-info">
                                <?php
                                // Avatar par défaut si pas de photo en BDD
        ...
        <?php else: ?>
            ...
            <?php if (!empty($suggestedCarpool)): ?>
                <p>
                    ...
                    <strong>
                        <?= date('d/m/Y H:i', strtotime($suggestedCarpool['departure_datetime'])) ?>
                    </strong>.
                </p>
            <?php else: ?>
                <p>
